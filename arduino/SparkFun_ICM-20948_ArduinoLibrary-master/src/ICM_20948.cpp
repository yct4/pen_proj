...
ICM_20948_Status_e ICM_20948::clearInterrupts(void)
{
  ...
  // there may be additional interrupts that need to be cleared, like FIFO overflow/watermark
...
ICM_20948_Status_e ICM_20948::initializeDMP(void) {
  ...
  uint8_t mstODRconfig = 0x03; // Set the ODR configuration to 1100/2^3 = 137.5Hz // TODO ODR
  ...
  //result = enableDLPF(ICM_20948_Internal_Gyr | ICM_20948_Internal_Acc, true); if (result > worstResult) worstResult = result; // TODO

//TODO
  // ICM_20948_dlpcfg_t dlpcfg;
  // dlpcfg.a = acc_d473bw_n499bw;
  // dlpcfg.g = gyr_d361bw4_n376bw5;
  // result = setDLPFcfg((ICM_20948_Internal_Acc | ICM_20948_Internal_Gyr), dlpcfg); if (result > worstResult) worstResult = result;
  ...
  // @param[in] gyro_level 0=250 dps, 1=500 dps, 2=1000 dps, 3=2000 dps //TODO g_fsr
  //result = setGyroSF(19, 3); if (result > worstResult) worstResult = result; // 19 = 55Hz (see above), 3 = 2000dps (see above)
  result = setGyroSF(9, 0); if (result > worstResult) worstResult = result; // 9 = 112Hz (see above), 0 = 250dps (see above) TODO ODR
  ...
  //  500dps : 2^26
  //  250dps : 2^25
  //const unsigned char gyroFullScale[4] = {0x10, 0x00, 0x00, 0x00}; // 2000dps : 2^28 // TODO g_fsr
  const unsigned char gyroFullScale[4] = {0x02, 0x00, 0x00, 0x00}; // 250dps : 2^25
  ...
  const unsigned char accelOnlyGain[4] = {0x01, 0xD1, 0x74, 0x5D}; // 112Hz TODO ODR
  result = writeDMPmems(ACCEL_ONLY_GAIN, 4, &accelOnlyGain[0]); if (result > worstResult) worstResult = result;

  // Configure the Accel Alpha Var: 1026019965 (225Hz) 977872018 (112Hz) 882002213 (56Hz)
  //const unsigned char accelAlphaVar[4] = {0x34, 0x92, 0x49, 0x25}; // 56Hz
  //const unsigned char accelAlphaVar[4] = {0x3D, 0x27, 0xD2, 0x7D}; // 225Hz
  const unsigned char accelAlphaVar[4] = {0x3A, 0x49, 0x24, 0x92}; // 112Hz TODO ODR
  result = writeDMPmems(ACCEL_ALPHA_VAR, 4, &accelAlphaVar[0]); if (result > worstResult) worstResult = result;

  // Configure the Accel A Var: 47721859 (225Hz) 95869806 (112Hz) 191739611 (56Hz)
  //const unsigned char accelAVar[4] = {0x0B, 0x6D, 0xB6, 0xDB}; // 56Hz
  //const unsigned char accelAVar[4] = {0x02, 0xD8, 0x2D, 0x83}; // 225Hz
  const unsigned char accelAVar[4] = {0x05, 0xB6, 0xDB, 0x6E}; // 112Hz TODO ODR
  ...
  //const unsigned char compassRate[2] = {0x00, 0x45}; // 69Hz = 0x45
  const unsigned char compassRate[2] = {0x00, 0x64}; // 100Hz = 0x64 Maximum data rate for compass TODO ODR
